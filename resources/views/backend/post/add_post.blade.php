        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ecrire Un ARTicle</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card">
                <div class="card-body p-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="post_title" class="form-control" id="input1" placeholder="Titre Article">
                        </div>

                        <div class="col-md-12">
                            <label for="input11" class="form-label">Courte Description</label>
                            <textarea class="form-control" name="short_desc" value rows="3"></textarea>
                        </div>

                        <div class="col-md-12">
                            <label for="input11" class="form-label">Description</label>
                            <textarea class="form-control" id="myeditorinstance" name="long_descp" value rows="3"></textarea>
                        </div>
