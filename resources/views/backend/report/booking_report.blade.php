         ...
         <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-4">
                        ...
                        <form class="row g-3" id="myForm" action="{{route('search-bay-date')}}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="col-md-6">
                                <label for="input1" class="form-label">Start Date</label>
                                <input type="date" name="start_date" class="form-control" id="input1" placeholder="Titre Article">
                            </div>

                            <div class="col-md-6">
                                <label for="input1" class="form-label">End Date</label>
                                <input type="date" name="end_date" class="form-control" id="input1" placeholder="Titre Article">
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" class="btn btn-primary px-4">Voir</button>
                                </div>
                            </div>
                    </form>
                </div>
