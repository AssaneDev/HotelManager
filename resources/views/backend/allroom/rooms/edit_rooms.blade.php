                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#primaryhome" role="tab" aria-selected="false" tabindex="-1">
                                    <div class="d-flex align-items-center">
                                        <div class="tab-icon"><i class="bx bx-home font-18 me-1"></i>
                                        </div>
                                        <div class="tab-title">Gestion Chambre</div>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#primaryprofile" role="tab" aria-selected="false" tabindex="-1">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="tab-title">Numéro Chambre</div>
                                    </div>
                                </a>
                            </li>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3" action="{{route('update.room',$editData->id)}}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <img id="showImage" src=" {{ (!empty($editData->image)) ? url('upload/roomimg/'.$editData->image)  : url('upload/no_image.jpg') }} " alt="Admin" class="bg-primary" width="70px" />
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="input4" class="form-label">Galerie Image</label>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="input1" class="form-label">Prix Chambre</label>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="input2" class="form-label">Capacité Chambre</label>
                                                    <input type="text" name="room_capacity" class="form-control" id="input2" value="{{$editData->room_capacity}}">
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="input2" class="form-label">Dimension Chambre</label>
                                                    <input type="text" name="size" class="form-control" id="input2" value="{{$editData->size}}">
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="input7" class="form-label">Vue chambre</label>
                                                    <select id="input7" name="view" class="form-select">
                                                        <option selected="">Choose...</option>
                                                        <option value="Vue Ocean" {{$editData->view == 'Vue Ocean'?'selected':''}} >Vue Ocean</option>
                                                        <option value="Vue Jardin" {{$editData->view == 'Vue Jardin'?'selected':''}}>Vue Jardin</option>
                                                        <option value="Vue Route"{{$editData->view == 'Vue Route'?'selected':''}}>Vue Route</option>
                                                    </select>
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="input7" class="form-label">Style Lit</label>
                                                    <select id="input7" name="bed_style" class="form-select">
                                                        <option selected="">Choose...</option>
                                                        <option value="Simple" {{$editData->bed_style == 'Simple'?'selected':''}}>Simple</option>
                                                        <option value="Double" {{$editData->bed_style == 'Double'?'selected':''}}>Double</option>
                                                        <option value="Triple" {{$editData->bed_style == 'Triple'?'selected':''}}>Triple</option>
                                                    </select>
                                                </div>


                                                <div class="col-md-12">
                                                    <label for="input11" class="form-label">Court Description</label>
                                                    <textarea class="form-control" id="input11" name="short_desc" value rows="3">{{$editData->short_desc}}</textarea>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="myeditorinstance" name="description" value rows="3">{!!$editData->description!!}</textarea>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <a class="card-title btn btn-primary float-right" onclick="addRoomNo()" id="addRoomNo">
                                                <i class="lni lni-plus">Ajouter</i>
                                            </a>
                                            ...
                                            <div class="roomnoHide" id="roomnoHide">
                                                <form action="{{route('store.room.no',$editData->id)}}" method="post">
                                                    ...
                                                    <div class="row" >
                                                            <div class="col-md-4">
                                                                <label for="input2" class="form-label">Numero Chambre</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <select id="input7" name="status" class="form-select">
                                                                    <option selected="">Status chambre</option>
                                                            ...
                                                            <div class="col-md-4">
                                                               <button type="submit" class="btn btn-success" style="margin-top: 29px"> Valider </button>
                                                            </div>
                                                    </div>      
                                                </form>
                                            ...
                                            <table class="table mb-0 table-striped" id="roomview">
                                                <thead>
                                                    <tr>
                                                        <th scope="col"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Numero Chambre</font></font></th>
                                                ...
                                                <tbody>
                                                    @foreach($allroomNo as $item)
                                                        <tr>
                                                            <th scope="row"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$item->room_no}}</th>
                                                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$item->status}}</td>
                                                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                                                <a href=" {{route('edit.roomno',$item->id)}} " class="btn btn-warning px-3 radius-30"> Modifier</a>
                                                                <a href="{{route('delete.roomno',$item->id)}}" class="btn btn-danger px-3 radius-30" id="delete"> Supprimer</a>
                                                            </font></font></td>
