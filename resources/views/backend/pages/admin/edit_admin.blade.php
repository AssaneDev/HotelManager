...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Modifier Admin</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Modifier Un Admin</li>
                </ol>
            </nav>
        </div>
         ...
         <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-4">
                        ...
                        <form class="row g-3" id="myForm" action="{{route('update.admin',$user->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="address" class="form-control" value="{{$user->adresse}}" >
