            ...
            <div class="col-lg-6">
                <div class="faq-content faq-content-bg2">
                    <div class="section-title">
                        <span class="sp-color">
                            N'hésitez pas à poser des questions</span>
                        ...
                        <ul class="accordion">
                            <li class="accordion-item">
                                <a class="accordion-title" href="javascript:void(0)">
                                    ...
                                    Comment vais-je réserver une chambre ou un complexe ?
                                </a>
                            ...
                            <li class="accordion-item">
                                <a class="accordion-title" href="javascript:void(0)">
                                    <i class='bx bx-plus'></i>
                                    Comment pourrai-je ajouter du contenu sur le portail d'administration ?
                                </a>
                            ...
                            <li class="accordion-item">
                                <a class="accordion-title active" href="javascript:void(0)">
                                    <i class='bx bx-plus'></i>
                                    Comment vais-je effectuer le paiement du livre de chambre ?
                                </a>
