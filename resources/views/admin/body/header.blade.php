        ...
        <nav class="navbar navbar-expand gap-3">
                                ...
                                <a class="dropdown-item" href="javascript:;" onclick="markNotificationAsRead('{{$notification->id}}')">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="msg-info">Nouvelle Notifications</p>
                                        </div>
                                    </div>
                                </a>
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.chance.password')}}"><i class="bx bx-cog fs-5"></i><span>Changer Motdepass</span></a>
                    </li>
