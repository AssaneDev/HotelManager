				...
				<div class="row g-0">
					...
					<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        ...
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body">
                                 <img src="{{asset('backend/assets/images/login-images/cover.jpg')}}" class="img-fluid auth-img-cover-login" width="650" alt=""/>
							</div>
						</div>
								...
								<div class="">
									...
									<div class="form-body">
                                        ...
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Mot de pass</label>
