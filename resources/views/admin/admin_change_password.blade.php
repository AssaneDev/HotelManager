...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Admin Change Motdepass</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Admin Change Motdepass</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="col-lg-8">
                    ...
                    <form action="{{route('admin.password.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0"> Nouveau Mot de pass</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Confimer le Mot de pass</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
